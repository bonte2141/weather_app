                ...
                <div class="col-md-4">
                    <div class="card custom-card-small text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="temperature-map-admin.php" class="btn btn-custom-light">View Map</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card custom-card-small text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="wind-map-admin.php" class="btn btn-custom-light">View Map</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card custom-card-small text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="radar-map-admin.php" class="btn btn-custom-light">View Map</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mt-4">
                    <div class="card custom-card-small text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="precipitation-map-admin.php" class="btn btn-custom-light">View Map</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mt-4">
                    <div class="card custom-card-small text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="cloud-coverage-map-admin.php" class="btn btn-custom-light">View Map</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mt-4">
                    <div class="card custom-card-small text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="pressure-map-admin.php" class="btn btn-custom-light">View Map</a>
                        </div>
                    </div>
                </div>
            </div>
