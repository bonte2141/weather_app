...
<head>
  ...
  <title>Cloud Coverage Map</title>
...
<body style="background-color: #121212; color: #ffffff;">
  ...
  <div class="container mt-5">
    <div class="custom-card">
      ...
      <h1 class="text-center fw-bold" style="font-size: 2.5rem; margin-bottom: 20px;">Cloud Coverage Map</h1>

      
      <div id="map">
        <div id="variable-name">Cloud Coverage</div>
