<nav class="navbar navbar-expand-lg bg-light" style="padding-top: 0; padding-bottom: 0;">
        <div class="container-fluid">
            <a class="navbar-brand" href="realtime-admin.php">
                <img src="climacast.webp" alt="ClimaCast" width="125" height="125" class="d-inline-block align-top">
            </a>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a href="realtime-admin.php" class="btn btn-dark fw-bold me-2" style="font-size: 23px;">Real-Time Weather</a>
                    </li>
                    <li class="nav-item">
                        <a href="forecast-admin.php" class="btn btn-dark fw-bold me-2" style="font-size: 23px;">Forecast</a>
                    </li>
                    <li class="nav-item">
                        <a href="locations-admin.php" class="btn btn-dark fw-bold me-2" style="font-size: 23px;">Locations</a>
                    </li>
                    <li class="nav-item">
                        <a href="interactivemaps-admin.php" class="btn btn-dark fw-bold me-2" style="font-size: 23px;">Interactive Maps</a>
                    </li>
                    <li class="nav-item">
                        <a href="feedback-admin.php" class="btn btn-dark fw-bold me-2" style="font-size: 23px;">Feedback</a>
                    </li>
                    <li class="nav-item">
                        <a href="users.php" class="btn btn-dark fw-bold me-2" style="font-size: 23px;">Users</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item fw-bold" href="profile-admin.php">
