...
<body style="background-color: #121212; color: #ffffff;">
  ...
  <div class="container mt-5">
    <div class="custom-card">
      ...
      <h1 class="text-center fw-bold" style="font-size: 2.5rem; margin-bottom: 20px;">Pressure Map</h1>
    ...
    <script>
      ...
      <script>
        ...
        const weatherLayer = new maptilerweather.PressureLayer({
          colorramp: maptilerweather.ColorRamp.builtin.PRESSURE, 
        });
